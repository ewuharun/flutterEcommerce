...
class _NewDashboardState extends State<NewDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> dashboardList = sharedValue == 0 ? Languages.bl_dashboardList : Languages.en_dashboardList;
...
//              onPressed: () => gotoNextPage(i),
  ...
  gotoNextPage(int i) {
    switch (i) {
      case 0:
        ...
        break;
      case 1:
        Route route = MaterialPageRoute(builder: (context)=>Stock());
        Navigator.push(context, route);
        break;
      case 2:
       Route route = MaterialPageRoute(builder: (context)=>SalesAdd());
       Navigator.push(context, route);
        break;
      case 3:
        Route route = MaterialPageRoute(builder: (context)=>OrderUpdate());
        Navigator.push(context, route);
        break;
  ...
  List<DashboardItems> dashBoardList() {
    return [
      DashboardItems(id: 1, name: "", imagePath: "", amount: 123)
    ];
  }
